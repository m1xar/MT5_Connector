...
class MT5OpenPosition(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("account_id", "external_id", name="uq_mt5openposition_account_external"),)
...
class MT5Transaction(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("account_id", "fingerprint", name="uq_mt5transaction_fingerprint"),)
